...
const db = require('better-sqlite3')('/Users/mora0145/Downloads/TrackWise/backend/data/trackwise.db');
const http = require('http');

// Load predictor
const Predictor = require('/Users/mora0145/Downloads/TrackWise/backend/src/ml/predictor.js');
  ...
  try {
    ...
    for (const runner of runners) {
      try {
        ...
        // Only include if positive EV and >5% confidence
